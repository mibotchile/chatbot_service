...
| Phase 4 (deploy track) | 4.1–4.6 | Correctly gated (B1+B2+B3 not cleared) |
...
| resolve_token path decision | OPEN | Must decide before PR2 merge (W2 above) |
...
PR2 is blocked on B1+B2+B3 + W2 resolve_token path decision.
